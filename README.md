...
- 로그 기록: `%LOCALAPPDATA%/WaffleRefresh/prs.log`

## 다운로드/실행

- 단일 EXE 위치
  - `WaffleRefresh/bin/Release/net8.0-windows/win-x64/publish/WaffleRefresh.exe`
